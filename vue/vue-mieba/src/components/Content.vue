...
export default {
  ...
  methods: {
    async convertImg (good) {
      let $canvas = await html2canvas(good)
      ...
      const anothnerCanvas = document.querySelector('#anotherGood canvas')
      const ctx2 = anothnerCanvas.getContext('2d')
